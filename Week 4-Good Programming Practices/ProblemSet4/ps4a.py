...
WORDLIST_FILENAME = r"C:\Users\Fernando\Documents\MITx-6.00.1x\Week 4-Good Programming Practices\ProblemSet4\words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    """
    assert len(word) != 0, "Not a valid word"
...
def calculateHandlen(hand):
    ...
    returns: integer
    """
    list_len = [hand[letter] for letter in hand]
    return sum(list_len)
